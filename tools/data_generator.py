...
def parse_args(argv: Optional[List[str]] = None):
    ...
    parser.add_argument("--users", type=validate_non_negative_int, default=50, help="Number of users to generate")
    parser.add_argument("--orders", type=validate_non_negative_int, default=200, help="Number of orders to generate")
    parser.add_argument("--trades", type=validate_non_negative_int, default=500, help="Number of trades to generate")
    parser.add_argument("--ticks", type=validate_non_negative_int, default=1000, help="Number of ticks per instrument")
    parser.add_argument("--candles", type=validate_non_negative_int, default=500, help="Number of candles per instrument")
